...
import galleryImage5 from '../assets/Landing page images/5-min.JPG';
import galleryImage6 from '../assets/Landing page images/6-min.JPG';
import galleryImage7 from '../assets/Landing page images/7-min.JPG';
import galleryImage8 from '../assets/Landing page images/8-min.jpg';
import galleryImage9 from '../assets/Landing page images/9-min.JPG';
import galleryImage10 from '../assets/Landing page images/10-min.JPG';
import founderImage from '../assets/Landing page images/admin/Satya Prasad Sir-min.jpg';
import ceoImage from '../assets/Landing page images/admin/Ajay Kumar-min.jpg';
import principalImage from '../assets/Landing page images/admin/Principal Lata-min.jpg';
import vicePrincipalImage from '../assets/Landing page images/admin/Harish.jpeg';


// Optimized Lazy Video Component - Uses poster image for fast LCP, loads video lazily but plays automatically
const LazyVideo = ({ videoSource }) => {
  ...
  // Start loading video immediately for faster LCP
  useEffect(() => {
    // Load video immediately for better LCP
    setShouldLoad(true);
...
const LandingPage = () => {
  ...
  // Memoize full text to avoid recreating on every render
  const memoizedFullText = useMemo(() =>
    "A compassionate, world‑class CBSE school dedicated to uplifting under‑privileged children, single‑parent families, and orphans — providing full scholarship, residential care.",
    []
  );

  const FULL_TEXT = memoizedFullText;
  ...
  React.useEffect(() => {
    const handleScroll = () => {
      ...
      const headerRect = sectionRef.current.getBoundingClientRect();
      const viewportHeight = window.innerHeight;

      // Show content when header is in viewport or just scrolled past
      // Only hide when header is significantly scrolled out of view (more than 100px)
      if (headerRect.bottom < -100) {
        // Header is scrolled well out of view - hide content
        setContentVisible(false);
      } else {
        // Header is in view or just scrolled past - always show content
  ...
  return (
    <main className="bg-white min-h-screen">
      <header ref={sectionRef} className="relative overflow-hidden h-screen bg-black">
        ...
        <div
          className={`absolute top-0 left-0 right-0 z-10 mx-auto max-w-7xl px-6 pt-20 sm:pt-24 md:pt-28 pb-28 text-center h-screen flex flex-col justify-center transition-opacity duration-300 ${contentVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'
            }`}
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-transparent/20 border border-white/40 px-3 py-1 text-[10px] sm:text-xs font-medium text-white backdrop-blur max-w-fit mx-auto whitespace-nowrap mt-20 sm:mt-24 md:mt-28 lg:mt-32 xl:mt-36">
          ...
          <div
            ref={buttonsRef}
            className={`mt-90 mb-8 md:mb-12 lg:mb-16 xl:mb-20 flex flex-nowrap items-center justify-center gap-3 transition-all duration-700 ease-out ${showButtons
          ...
          >
            <Link
              to="/admission"
              className="rounded-full bg-gradient-to-r from-brand-500 to-brand-500 px-5 sm:px-8 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base font-semibold text-white shadow-md transition hover:shadow-lg hover:from-brand-600 hover:to-brand-500 whitespace-nowrap"
            >
              Apply for Admissions
            </Link>
            <Link
              to="/about"
              className="rounded-full bg-transparent border border-white px-5 sm:px-8 py-3 sm:py-3.5 md:py-4 text-sm sm:text-base font-semibold text-white backdrop-blur transition hover:bg-white/20 whitespace-nowrap"
            >
              Our Mission
            </Link>
          </div>
      ...
      <section id="gallery" className="w-full mb-3 pb-12 bg-gradient-to-b from-white via-brand-50/20 to-white rounded-3xl overflow-hidden relative">
        {/* Decorative background elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-brand-100/10 via-transparent to-brand-100/10 rounded-3xl -z-10"></div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-stretch py-6 md:py-8">
            ...
            >
              <div className="relative w-full h-full bg-gradient-to-br from-brand-50/80 via-brand-50/50 to-white rounded-3xl p-4 md:p-6 lg:p-8 overflow-hidden shadow-2xl border-2 border-brand-300/60 hover:border-brand-400/80 transition-colors">
          ...
          <Suspense fallback={
            ...
            <Gallery images={[
              ...
              },
              {
                ...
                description: "Students engaged in outdoor art and painting activities"

              },
              {
                url: galleryImage3,
                title: "School Life",
                description: "Students in school uniforms walking through bright hallway"

              },
              {
                url: galleryImage4,
                title: "Team Spirit",
                description: "Basketball team showing unity and sportsmanship"

              },
              {
                url: galleryImage5,
                title: "Academic Focus",
                description: "Students focused on their studies in classroom"
              },
              {
                url: galleryImage6,
                title: "Hearts United in Friendship",
                description: "A circle of care where children stand together"
              },
              {
                url: galleryImage7,
                title: "Dedicated Learning",
                description: "Students working diligently in their classroom"
              },
              {
                url: galleryImage8,
                title: "Sports Excellence",
                description: "Students playing basketball at sunset on school court"
              },
              {
                url: galleryImage9,
                title: "Artistic Expression",
                description: "Students creating beautiful artwork in art class"

              },
              {
                url: galleryImage10,
                title: "Joyful Moments",
                description: "Students enjoying outdoor activities and playtime"
              }
            ]} />
          </Suspense>
        </div>
      ...
      <section className="relative overflow-hidden pt-12 md:pt-16 lg:pt-20 pb-6 md:pb-8 z-10 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <div className="text-center relative z-10">
            ...
            >
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 md:p-8 lg:p-10 shadow-lg border-2 border-brand-300/60 hover:border-brand-400/80 transition-colors">
      ...
      {/* Our Story Section */}
      <section className="relative overflow-hidden pt-6 md:pt-8 pb-12 md:pb-16 lg:pb-20 z-10 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <div className="relative z-10">
            ...
            <motion.div
              ...
              className="w-full relative pt-6 md:pt-8 lg:pt-10"
            >
              <div className="relative rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-12 lg:p-16 shadow-2xl space-y-3 sm:space-y-4 md:space-y-6 overflow-hidden"
                style={{
                  background: `
                  linear-gradient(135deg, #ffffff 0%, #f8fafc 40%, #f0f9ff 100%),
                  radial-gradient(circle at 20% 20%, rgba(0,171,217,0.05) 0%, transparent 40%),
                  radial-gradient(circle at 80% 80%, rgba(0,171,217,0.03) 0%, transparent 40%)
                `,
                  border: '2px solid #e2e8f0',
                  boxShadow: `
                  0 20px 50px rgba(0,171,217,0.08),
                  inset 0 0 60px rgba(255,255,255,1),
                  0 0 0 1px rgba(0,171,217,0.1)
                `,
                  position: 'relative'
                }}
              >
                {/* Ornate border pattern - Royal Kingdom style */}
                <div className="absolute inset-0 pointer-events-none" style={{
                  border: '1px solid rgba(0,171,217,0.15)',
                  borderRadius: 'inherit',
                  margin: '6px'
                }}></div>

                {/* Ancient paper texture overlay with more detail */}
                <div
                  className="absolute inset-0 opacity-10 pointer-events-none"
                  style={{
                    backgroundImage: `
                    radial-gradient(circle at 10% 10%, rgba(0,171,217,0.05) 0%, transparent 20%),
                    radial-gradient(circle at 90% 90%, rgba(0,171,217,0.05) 0%, transparent 20%)
                  `,
                  }}
                ></div>

                {/* Aged/worn edges effect - more pronounced */}
                <div className="absolute inset-0 pointer-events-none" style={{
                  background: `
                  linear-gradient(to bottom right, rgba(0,171,217,0.02) 0%, transparent 40%, transparent 60%, rgba(0,171,217,0.02) 100%)
                `
                }}></div>

                {/* Royal decorative corner elements - more ornate */}
                <div className="absolute top-0 left-0 w-16 h-16 pointer-events-none" style={{
                  borderTop: '3px solid rgba(0,171,217,0.3)',
                  borderLeft: '3px solid rgba(0,171,217,0.3)',
                  borderTopLeftRadius: '8px',
                }}></div>
                <div className="absolute top-0 right-0 w-16 h-16 pointer-events-none" style={{
                  borderTop: '3px solid rgba(0,171,217,0.3)',
                  borderRight: '3px solid rgba(0,171,217,0.3)',
                  borderTopRightRadius: '8px',
                }}></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 pointer-events-none" style={{
                  borderBottom: '3px solid rgba(0,171,217,0.3)',
                  borderLeft: '3px solid rgba(0,171,217,0.3)',
                ...
                {/* Decorative flourishes at corners - Kingdom style */}
                <div className="absolute top-2 left-2 text-brand-500/10 text-4xl font-serif">❋</div>
                <div className="absolute top-2 right-2 text-brand-500/10 text-4xl font-serif">❋</div>
                <div className="absolute bottom-2 left-2 text-brand-500/10 text-4xl font-serif">❋</div>
                <div className="absolute bottom-2 right-2 text-brand-500/10 text-4xl font-serif">❋</div>

                {/* Text Content - full width */}
                <div className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-medium space-y-3 sm:space-y-4 md:space-y-6 text-justify relative z-20 w-full px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-3 md:py-4"
                  style={{
                    color: '#0f172a',
                ...
                >
                  <p>
                    <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span> was built on a clear conviction: education must reach the child who needs it most.
                  </p>
                  <p>
                    What began in <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>1968</span> as <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>Praja Seva Samithi</span> evolved into <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span> – <span className="font-bold" style={{ color: '#00abd9' }}>Health and Education for All</span> in <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>1992</span>, under the vision of <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>Dr. Koneru Satya Prasad</span>. The purpose was never expansion for its own sake. It was to take complete responsibility for children who had no support system.
                  </p>
                  <p>
                    <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span> works with orphans, semi-orphans, and children from deeply underprivileged families. For them, education alone is insufficient. Stability, discipline, care, and values are equally essential. <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span> provides all of this under one system: schooling, accommodation, nutrition, healthcare, and moral guidance.
                  </p>
                  <p>
                  ...
                  <p>
                    Success at <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span> is measured by independence. Children are guided until they are educated, employable, and confident enough to stand on their own. Many return as professionals and contributors, proving the model works.
                  </p>
                  <p>
                    <span className="font-extrabold" style={{ color: '#00abd9', fontSize: 'clamp(1.15em, 4vw, 1.3em)' }}>HEAL</span>'s story is simple and deliberate.
                  </p>
                </div>

                {/* Royal seal/divider line */}
                <div className="pt-6 md:pt-8 relative z-20 flex items-center justify-center">
                  <div className="flex-1 h-px bg-slate-200"></div>
                  <div className="mx-4 text-brand-500/20 text-2xl">✦</div>
                  <div className="flex-1 h-px bg-slate-200"></div>
                </div>

                <div className="pt-3 sm:pt-4 md:pt-6 relative z-20">
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed font-bold italic text-center"
                    style={{
                      color: '#0369a1',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative z-10">
            {[
              ...
              <motion.div
                ...
                className="group relative bg-white rounded-2xl sm:rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-brand-300/60 hover:border-brand-400/80"
              >
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            ...
            >
              ...
              {/* Text container */}
              <div className="relative bg-gradient-to-r from-brand-50/80 via-white to-brand-50/80 backdrop-blur-sm rounded-xl sm:rounded-2xl px-3 sm:px-4 md:px-6 lg:px-10 py-4 sm:py-5 md:py-6 lg:py-8 border-2 border-brand-300/60 hover:border-brand-400/80 shadow-xl w-full transition-colors">
                <motion.p
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  viewport={{ once: false, margin: "0px" }}
      ...
      < article className="mx-auto max-w-7xl px-4 sm:px-6 py-8 md:py-12" >
        <motion.div
          ...
          transition={{ duration: 0.4 }}
          className="relative bg-gradient-to-br from-white via-brand-50/70 to-brand-50/60 rounded-xl sm:rounded-2xl p-6 md:p-8 lg:p-10 shadow-xl border-2 border-brand-300/60 hover:border-brand-400/80 overflow-hidden transition-colors"
        >
          ...
          <div className="absolute inset-0 opacity-[0.08] bg-[linear-gradient(to_right,#00abd9_1px,transparent_1px),linear-gradient(to_bottom,#00abd9_1px,transparent_1px)] bg-[size:24px_24px]"></div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-5 lg:gap-6 items-start lg:items-center">
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-brand-400/60 to-brand-400/60 rounded-full blur-xl pointer-events-none"
                  animate={{
                    opacity: [0.5, 0.7, 0.5],
                    scale: [1, 1.08, 1]
                  }}
                ...
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-brand-300 via-brand-300 to-brand-300 p-0.5 animate-spin-slow opacity-70 pointer-events-none">
                  <div className="w-full h-full rounded-full bg-white"></div>
                </div>

                <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full overflow-hidden ring-3 ring-brand-200/90 ring-offset-2 ring-offset-white shadow-lg">
                  <img
                    src={founderImage}
                    alt="Dr. Koneru Satya Prasad - Founder of HEAL"
                    loading="lazy"
                    decoding="async"
                    fetchPriority="auto"
                    width="400"
                  ...
                  />
                  {/* Subtle overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-brand-900/10 via-transparent to-transparent pointer-events-none"></div>
                </div>
      ...
      < section className="mx-auto max-w-7xl px-4 sm:px-6 pb-8" >
        ...
        <Suspense fallback={
          ...
          <TeamTestimonials
            testimonials={[
              {
                name: "Mrs. Lata Yarlagadda",
                designation: "Principal",
                src: principalImage,
                quote: "Principal of HEAL School, bringing close to two decades of solid leadership experience and a clear alignment with HEAL's founding philosophy envisioned by Dr. Koneru Satya Prasad, Her leadership focuses on discipline with dignity, curriculum strength."
              },
              {
                name: "Mr. Harish Mikkilineni",
                designation: "Vice Principal",
                src: vicePrincipalImage,
                quote: "Vice Principal of HEAL School with a background that blends structured thinking, systems orientation, and strong execution discipline,  His exposure to large-scale systems, multilingual environments, and technology-driven workflows strengthens HEAL"
              },
              {
                name: "Mr. Kurapati Ajay Kumar",
                designation: "CEO - Heal Charity",
                src: ceoImage,
                quote: "A retired Indian Revenue Service (IRS) officer with decades of leadership and since 2016, has been associated with HEAL as CEO, leading initiatives that provide free education, healthcare to orphaned and underprivileged children."
              }
            ]}
            autoplay={true}
          />
